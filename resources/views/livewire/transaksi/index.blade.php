            ...
            <tbody>
                @forelse ($patients as $patient)
                    <tr class="border-t border-gray-600">
                        ...
                        <td class="px-4 py-2">{{ $patient->hargaTindakan->visitType->name ?? '-' }}</td>
                        <td class="px-4 py-2">Rp {{ number_format($patient->hargaTindakan->price ?? 0, 0, ',', '.') }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center py-4 text-gray-400">Tidak ada pasien menunggu pembayaran.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
